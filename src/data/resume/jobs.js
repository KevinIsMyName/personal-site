const jobs = [
  ...
  },
  {
    ...
    points: [
      'Returning part-time offer while taking classes',
    ],
  },
  {
    ...
    position: 'Software Engineer Co-op',
    link: 'https://sig.com/',
    daterange: 'April 2020 - September 2020',
    points: [
  ...
  },
  {
    ...
    points: [
      'Developed a Python script to convert course schedule Excel sheets to CSVs for registering class livestreams per quarter',
      'Developed a Selenium script to initialize over 200 course directory webpages and learning module systems per quarter',
      'Spearheaded computer and telephone setups for 5‑8 new faculty per quarter with university‑wide IT staff',
      'Trained 3‑5 new hires per quarter on information systems software and audio‑visual presentation equipment as senior‑level assistant',
    ],
  },
];
